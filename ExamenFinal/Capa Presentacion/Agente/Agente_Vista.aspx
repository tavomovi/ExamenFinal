<%@ Page Language="C#" MasterPageFile="~/Capa Presentacion/Master/Menu.Master" AutoEventWireup="true" CodeBehind="Agente_Vista.aspx.cs" Inherits="ExamenFinal.Capa_Presentacion.Agente_Vista" %>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <div class="mb-3">
                                    ...
                                    <asp:TextBox runat="server" class="form-control form-control-sm" ID="txtAgenteID" Style="width: 200px; height: 30px !important;"></asp:TextBox>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <asp:TextBox runat="server" CssClass="form-control" TextMode="Password" ID="txtPass" MaxLength="10"></asp:TextBox>
                                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <asp:GridView ID="gvClientes" runat="server" AutoGenerateColumns="False" Width="850px">
                    <Columns>
                        <asp:BoundField DataField="ID" HeaderText="ID Agente" />
